...
class EAS_Scheduler:
    def __init__(self, tasks, nodes, num_ants=10, max_iter=50, 
                    alpha=1.0, beta=2.0, rho=0.1, q=1.0, e=5):
    ...
    def update_pheromone(self, solutions, best_solution):
        ...
        for task_idx, node_idx in best_solution['assignments']:
            self.pheromone[task_idx][node_idx] += self.e * self.q * fitness
    ...
    def run(self):
        ...
        for iteration in range(self.max_iter):
            ...
            self.update_pheromone(solutions, best_solution)
